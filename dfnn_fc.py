...
def dfnn_fc_ite_rules(max_rules, param_setting: ParamConfig, patition_strategy: KFoldPartition,
    ...
    for i in torch.arange(max_rules):
        ...
        loss_list_temp, loss_dlist_temp, loss_admm_list_temp = \
            dfnn_fc_method(n_rule, param_setting, patition_strategy, dataset, loss_function)
