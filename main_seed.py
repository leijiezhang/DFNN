...
from dfnn_run import fuzzy_net_run, mlp_run, neuron_run, dfnn_kfolds, dfnn_ite_rules_mu
...
for jj in torch.arange(len(n_channel_list)):
    ...
    data_save_dir = f"./results/seed/"

    if not os.path.exists(data_save_dir):
        os.makedirs(data_save_dir)
    data_save_file = f"{data_save_dir}/channel{n_channel}.pt"
