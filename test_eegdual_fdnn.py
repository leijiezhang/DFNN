...
from dfnn_run import fuzzy_dnn_run, svm_local, mlp_run, neuron_run, dfnn_kfolds
...
param_config.config_parse('eegdual_fdnn_config')
...
for i in torch.arange(len(param_config.dataset_list)):
    ...
    # train_data.Y = train_data.Y_r
    # test_data.Y = test_data.Y_r
    ...
    acc_c_train, acc_c_test = \
        fuzzy_dnn_run(param_config, train_data, test_data)
    acc_d_train = 0.0
    acc_d_test = 0.0
